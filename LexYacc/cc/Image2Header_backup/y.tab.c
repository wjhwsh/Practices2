...
{
       0,    57,    57,    60,    61,    62,    65,    83,   107,   132,
     135,   136,   138,   139,   140,   141,   142,   146,   154,   159,
     162,   165,   171,   177,   183,   184
};
#endif
...
static const yytype_uint8 yydefact[] =
{
      ...
      14,    25,     7,     3,     0,     0,     0,     0,     0,     0,
       9,    12,    12,     6,    23,     0,    20,     0,     0,    17,
      18,    12,    13,    10,    16,     0,    21,    22,     0,    22,
      15
};
...
static const yytype_int8 yypact[] =
{
     ...
     -10,     8,     8,   -10,   -10,    32,   -10,     3,    38,   -10,
     -10,     8,   -10,   -10,   -10,    39,   -10,   -10,    25,   -10,
     -10
};
...
static const yytype_uint8 yytable[] =
{
      ...
      46,    25,    17,    44,    27,    28,     1,     5,     7,    24,
      16,    31,    48,    30,    37,    34,    32,    39,    38,    40,
      50,    45,    47,    49,    23,    43,     0,    21,     0,     0,
      29
};
...
#line 165 "Image2Header.y"
  ...
  case 22:
#line 171 "Image2Header.y"
    { 
            int i = body_line_count;
            body[2*i] = xtoi((yyvsp[(2) - (4)].str));
            body[2*i + 1] = xtoi((yyvsp[(4) - (4)].str));
            body_line_count++; 
        }
    break;
